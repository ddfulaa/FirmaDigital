...
/* package firmadigital-0.1.0.0 */
#ifndef VERSION_firmadigital
#define VERSION_firmadigital "0.1.0.0"
#endif /* VERSION_firmadigital */
#ifndef MIN_VERSION_firmadigital
#define MIN_VERSION_firmadigital(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_firmadigital */
...
#define CURRENT_COMPONENT_ID "firmadigital-0.1.0.0-inplace-firmadigital"
